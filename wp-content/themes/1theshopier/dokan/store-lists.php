<div class="dokan-seller-listing">
    ...
    if ( $sellers['users'] ) {
        ...
        $__columns = !empty($theshopier_datas['store-list-columns'])? absint($theshopier_datas['store-list-columns']): 4;

        $resp = array('dokan-single-seller');
        ...
        ?>
        <div class="dokan-seller-wrap row">
            <?php
            foreach ( $sellers['users'] as $seller ) {
                ...
                <section class="<?php echo esc_attr(implode(' ', $resp)); ?>">
