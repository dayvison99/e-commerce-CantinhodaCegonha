...
<form class="cart" action="<?php echo esc_url( get_permalink() ); ?>" method="post" enctype='multipart/form-data'>
        ...
        <tbody>
            <?php
                ...
                foreach ( $grouped_products as $grouped_product ) {
                    ...
                    ?>
                    <tr id="product-<?php echo esc_attr( get_the_ID() ); ?>" class="woocommerce-grouped-product-list-item <?php echo esc_attr( implode( ' ', get_post_class() ) ); ?>">
                    <?php
    ...
    <?php if ( $quantites_required ) : ?>
        ...
        <button type="submit" class="single_add_to_cart_button button alt icon-nth-cart"><?php echo esc_html( $product->single_add_to_cart_text() ); ?></button>
