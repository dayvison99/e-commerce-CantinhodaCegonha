 ...
 */
function storebiz_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function storebiz_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function storebiz_sanitize_html( $html ) {
 ...
 */
function storebiz_sanitize_image( $image, $setting ) {
 ...
 */
function storebiz_sanitize_nohtml( $nohtml ) {
 ...
 */
function storebiz_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function storebiz_sanitize_range_value( $number, $setting ) {
 ...
 */
function storebiz_sanitize_select( $input, $setting ) {
 ...
 */
function storebiz_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function storebiz_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function storebiz_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}