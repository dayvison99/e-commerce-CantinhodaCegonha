! function(e, t) {
    ...
    ({
        ...
        init: function() {
            this.$document.on("ready", this.documentIsReady.bind(this)), this.$document.on("ready", this.mobileMainMenuClone.bind(this)), this.$document.on("ready", this.mobileMainMenuRightClone.bind(this)), this.$document.on("ready", this.autoHeightSetOnHeader.bind(this)), this.$document.on("ready", this.autoHeightBreadcrumbMenu.bind(this)), this.$window.on("ready", this.documentIsReady.bind(this))
        },
        documentIsReady: function() {
            this.$document.on("click." + this.customID, ".menu-collapsed", this.mainMenuCollapse.bind(this)).on("click." + this.customID, ".header-close-menu", this.mainMenuCollapse.bind(this)).on("click." + this.customID, this.mainMenuHideMobilePopup.bind(this)).on("click." + this.customID, ".mobile-collapsed", this.mobileSubMenuCollapse.bind(this)).on("click." + this.customID, ".header-close-menu", this.resetMobileMenuCollapse.bind(this)).on("click." + this.customID, ".browse-btn", this.browseMenuCollapse.bind(this)).on("mainMenuHideMobilePopup." + this.customID, this.resetMobileMenuCollapse.bind(this)).on("resize." + this.customID, this.autoHeightSetOnHeader.bind(this)).on("resize." + this.customID, this.autoHeightBreadcrumbMenu.bind(this)).on("click." + this.customID, ".header-search-toggle", this.searchPopUpToggle.bind(this)).on("click." + this.customID, ".header-search-close", this.searchPopUpToggle.bind(this)), this.$window.on("load." + this.customID, this.MainMenuFocusAccessibility.bind(this)).on("load." + this.customID, this.headerAboveBarMobile.bind(this)).on("load." + this.customID, this.breadcrumbMenuMobile.bind(this)).on("load." + this.customID, this.autoHeightSetOnHeader.bind(this)).on("resize." + this.customID, this.autoHeightSetOnHeader.bind(this)).on("resize." + this.customID, this.autoHeightBreadcrumbMenu.bind(this))
        },
        ...
        MainMenuFocusAccessibility: function(t) {
            e(".main-navbar, .widget_nav_menu, .browse-menu").find("a").on("focus blur", function() {
        ...
        headerAboveAccessibility: function() {
            if (e(".above-header").length > 0) {
                var t, i, n, a = document.querySelector(".header-above-bar");
        ...
        breadcrumbMenuAccessibility: function() {
            if (e(".breadcrumb-mobile-menu").length > 0) {
                var t, i, n, a = document.querySelector(".breadcrumb-mobile-menu");
                let e = 'button, [href], input, select, textarea, [tabindex]:not([tabindex="-1"])',
        ...
        breadcrumbMenuMobile: function() {
            if (e(".breadcrumb-mobile-menu").length > 0) {
                ...
                !i.children().length > 0 ? (i.hide(), n.hide()) : (n.show(), i.clone().appendTo(".breadcrumb-mobile-menu"), a.on("click", function(e) {
