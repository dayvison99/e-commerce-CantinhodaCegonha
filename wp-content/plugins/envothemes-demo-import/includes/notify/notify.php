...
function envothemes_pro_notice() {
    ...
    if (time() - $activation_time > $daysinseconds) {
        if (defined(defined('ENVO_SHOPPER_PRO_CURRENT_VERSION') || 'ENVO_ECOMMERCE_PRO_CURRENT_VERSION') || defined('ENVO_STOREFRONT_PRO_CURRENT_VERSION') || defined('ENVO_SHOP_PRO_CURRENT_VERSION') || defined('ENVO_ONLINE_STORE_PRO_CURRENT_VERSION') || defined('ENVO_MARKETPLACE_PRO_CURRENT_VERSION')) {
            return;
        }
